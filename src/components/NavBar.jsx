    ...
    <nav className="fixed top-0 z-50 w-full bg-white shadow-lg">
      <div className="flex justify-between items-center h-16 px-4 max-w-[1240px] mx-auto">
        ...
        <ul
          ...
          } font-mono md:mt-0 mt-4 absolute md:relative top-full left-0 md:top-0 md:left-auto md:flex flex-col md:flex-row bg-white sm:bg-transparent w-full sm:w-auto justify-center items-center`}
        >
