...
const Contact = () => {
  return (
    <div className="max-w-screen-xl mx-auto lg:flex lg:flex-row sm:flex-col mt-32 mb-16">
      ...
      <div className="lg:w-1/2 flex flex-col space-y-4 text-gray-800 py-3 px-3">
        ...
        {data.map((trending, index) => (
          <div className="lg:flex lg:flex-row space-x-10" key={trending.id}>
            ...
            <div className="lg:w-1/2 flex flex-row mb-6" key={trending.id}>
